...
test('geojsonhint', function (t) {
    _glob2.default.sync('test/data/good/*.geojson').forEach(function (f) {
        var gj = file(f);
        t.deepEqual((0, _.hint)(gj), [], f);
    });
    t.deepEqual((0, _.hint)(undefined), [{
        message: 'Expected string or object as input',
        line: 0
    }], 'expected string input');
    t.deepEqual((0, _.hint)('{}'), [{
    ...
    test('validates incorrect files', function (t) {
        _glob2.default.sync('test/data/bad/*.geojson').forEach(function (f) {
            ...
            if (process.env.UPDATE) {
                _fs2.default.writeFileSync(f.replace('geojson', 'result'), JSON.stringify((0, _.hint)(gj), null, 2));
            }
            t.deepEqual((0, _.hint)(gj), filejs(f.replace('geojson', 'result')), f);
        });
        t.end();
    });
    ...
    test('validates incorrect files as objects', function (t) {
        _glob2.default.sync('test/data/bad/*.geojson').forEach(function (f) {
            ...
            var gj = filejs(f);
            if (process.env.UPDATE) {
                _fs2.default.writeFileSync(f.replace('geojson', 'result-object'), JSON.stringify((0, _.hint)(gj), null, 2));
            }
            t.deepEqual((0, _.hint)(gj), filejs(f.replace('geojson', 'result-object')), f);
        });
        t.end();
    });
    test('noDuplicateMembers option=false', function (t) {
        t.deepEqual((0, _.hint)('{"type":"invalid","type":"Feature","properties":{},"geometry":null}', {
    ...
    test('noDuplicateMembers option=true', function (t) {
        t.deepEqual((0, _.hint)('{ "type": "Point", "coordinates": [100.0000000001, 5.0000000001] }', {
    ...
    test('noDuplicateMembers option=true', function (t) {
        ...
        }var truncated = (0, _.hint)(JSON.stringify(featureCollection, null, 2), {
            precisionWarning: true
        });
    ...
    test('invalid roots', function (t) {
        t.deepEqual((0, _.hint)('null'), [{
            message: 'The root of a GeoJSON object must be an object.',
            line: 0
        }], 'non-object root');
        t.deepEqual((0, _.hint)('1'), [{
            message: 'The root of a GeoJSON object must be an object.',
            line: 0
        }], 'number root');
        t.deepEqual((0, _.hint)('"string"'), [{
            message: 'The root of a GeoJSON object must be an object.',
            line: 0
        }], 'string root');
        t.end();
