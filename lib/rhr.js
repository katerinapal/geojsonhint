...
var mod_anonymus = function validateRightHandRule(geometry, errors) {
...
exports.rhr = mod_anonymus = function validateRightHandRule(geometry, errors) {
    if (!rightHandRule(geometry)) {
        errors.push({
            message: 'Polygons and MultiPolygons should follow the right-hand rule',
            level: 'message',
