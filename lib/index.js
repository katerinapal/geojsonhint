import ext_jsonlintlines_jsonlint from "jsonlint-lines";
import { hint as object_hintjs } from "./object";
...
function hint(str, options) {
    ...
    if (typeof str === 'object') {
        ...
        try {
            gj = ext_jsonlintlines_jsonlint.parse(str);
        } catch(e) {
    ...
    errors = errors.concat(object_hintjs.hint(gj, options));
